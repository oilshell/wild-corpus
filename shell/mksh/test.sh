#!/home/andy/src/mksh/mksh
LC_ALL=C PATH='/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/home/andy/bin'; export LC_ALL PATH
test -n "$KSH_VERSION" || exit 1
set -A check_categories --  shell:legacy-no int:32
pflag='/home/andy/src/mksh/mksh'
sflag='./check.t'
